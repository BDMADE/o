    ...
    module Checkout
      def self.included(klass)
        klass.class_eval do
          ...
          # calculate total payment with bkash discount
          def order_total_after_bkash
            order_total_after_store_credit + @updating_params[:order][:bkash_discount_total].to_f
          end
          ...
          def update_params_payment_source
            ...
            if @updating_params[:order] && (@updating_params[:order][:payments_attributes] ||
              ...
              @updating_params[:order][:payments_attributes].first[:amount] = order_total_after_bkash
            end
          end
        end
      end
